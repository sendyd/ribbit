<template>
  <div class="goods-comment">
    ...
    <div class="list" v-if="commentList">
     ...
     <!-- 分页 -->
    <XtxPagination v-if="commentList" @current-change="changePager" :total="total" :current-page="reqParams.page"  />
  </div>
</template>
<script>
...
export default {
  ...
  setup(props) {
    ...
    watch(reqParams, async () => {
      const data = await findCommentList(goods.id, reqParams)
    ...
    return { commentInfo, currTagIndex, changeTag, commentList, reqParams, changeSort, formatSpecs, formatNickname , changePager , total}
  }
