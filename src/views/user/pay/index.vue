...
const redirect = encodeURIComponent('http://localhost:3000/#/member/callback')
  ...
  <div class="xtx-pay-page">
    ...
    <XtxDialog title="正在支付..." v-model:visible="visibleDialog">
      <div class="pay-wait">
        ...
        <div v-if="order">
          <p>如果支付成功：</p>
          <RouterLink @click="visibleDialog = false" :to="{path:'/member/pay',query:{id:order.id}}">查看订单详情></RouterLink>
          <p>如果支付失败：</p>
