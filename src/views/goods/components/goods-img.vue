...
const usePreviewImg = () => {
  ...
  watch([elementX, elementY, isOutside], () => {
    ...
    // 设置大背景的定位
    bgPosition.backgroundPositionX = -position.x * 2 + 'px'
    bgPosition.backgroundPositionY = -position.y * 2 + 'px'
    // 设置遮罩容器的定位
  ...
  return { layerPosition, bgPosition, show, target }
}

const { layerPosition, bgPosition, show, target } = usePreviewImg()
</script>
